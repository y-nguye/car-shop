                ...
                <div class="carousel-inner">
                    <?php if (empty($data_all_car_img[1])) : ?>
                        <div class="carousel-item carousel-item-custom__product-page--overlay active">
                            <img src="/project/car-shop/assets/imgs/no-img.jpg" alt="" class="d-block w-100">
                        </div>
                    <?php endif ?>
                    ...
                    <?php foreach ($data_all_car_img as $index => $data) : ?>
                        ...
                        <?php if ($data['car_img_filename'] && file_exists(__DIR__ . '/../../../../assets/uploads/' . $data['car_img_filename'])) : ?>
                            <div class="carousel-item carousel-item-custom__product-page--overlay" data-index="<?= $index ?>">
                                <img src="/project/car-shop/assets/uploads/<?= $data['car_img_filename'] ?>" alt="" class="d-block w-100">
                            </div>
                        <?php else : ?>
                            <div class="carousel-item carousel-item-custom__product-page--overlay" data-index="<?= $index ?>">
                                <img src="/project/car-shop/assets/imgs/no-img.jpg" alt="" class="d-block w-100">
                ...
                <form name="formProductCar" class="d-flex flex-column h-100" method="post" action="">
                    ...
                    <div class="mt-auto">
                        ...
                        <div class="d-flex">
                            ...
                            <a class="btn btn-outline-secondary w-50" href="/project/car-shop/test-drive/<?= $data_car['car_id'] ?>">Đăng ký lái thử</a>
                        </div>
                    </div>
        ...
        <div class="row mt-3">
            <div class="d-flex align-items-center justify-content-center mb-5">
                <?php if (isset($data_all_car_img[0]['car_img_filename']) && file_exists(__DIR__ . '/../../../../assets/uploads/' . $data_all_car_img[0]['car_img_filename'])) : ?>
                    <img src="/project/car-shop/assets/uploads/<?= $data_all_car_img[0]['car_img_filename'] ?>" alt="" class=" w-50">
                <?php else : ?>
                    <img src="/project/car-shop/assets/imgs/no-img.jpg" alt="" class="w-50">
                <?php endif ?>
            </div>
