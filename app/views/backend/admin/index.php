            ...
            <div class="col-9">
                ...
                <div class="mt-5">
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <a class="border text-secondary border-secondary rounded-3 me-3 card-custom__admin-page" href="<?= BASE_URL ?>/admin/product/add">
                        ...
                        <a class="border text-secondary border-secondary rounded-3 ms-3 card-custom__admin-page" href="<?= BASE_URL ?>/admin/manage">
                            <div class="card" style="width: 15rem; aspect-ratio: 1/1;">
                                <div class="card-body text-center d-flex flex-column justify-content-center">
